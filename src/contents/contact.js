const contactComponent = (() => {
  ...
  function addElementsTextContent() {
    ...
    contactTextParagraph1.appendChild(document.createTextNode('742 Street Address - City/State'));
    contactTextParagraph2.appendChild(document.createTextNode('999-999-9999 - restaurant@mail.com - www.restaurant.com'));
